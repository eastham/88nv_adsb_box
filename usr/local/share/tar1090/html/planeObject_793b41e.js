...
const playanames = {
  "N5286C": "foo testing really long string",
  "N291SY": "Foo2",
};
...
PlaneObject.prototype.updateIcon = function() {
    ...
    if ( enableLabels && (!multiSelect || (multiSelect && this.selected)) &&
        ...
        if (extendedLabels < 3) {
            if (this.registration && playanames[this.registration.trim().toUpperCase()]) {
		labelText += playanames[this.registration.trim().toUpperCase()];
	    } else {		
		labelText += callsign;
	    }
        }
